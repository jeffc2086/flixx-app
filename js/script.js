const global = {
    ...
    api: {
        // API key here for demo purposes ONLY                   
        apiKey: '630e779d27a7ec957ada7c17f8a68103',
...
// Display 20 most popular 20 TV shows
async function displayPopularShows() {
    ...
    results.forEach(show => {
        ...
        />` :
            ...
            src="images/no-image.jpg"
            class="card-img-top"
            alt="${show.orignal_name}"
          />`
        }
        </a>
        <div class="card-body">
          <h5 class="card-title">${show.orignal_name}</h5>
          <p class="card-text">
...
function displayBGImage(type, path) {
